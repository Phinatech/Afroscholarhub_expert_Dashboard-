  ...
  const token1  = localStorage.getItem("accessToken");
    ...
    if (storedToken && token1) {
      try {
        ...
        // console.log("refe-mob", refreshToken); 
        // console.log("acc-mob", token); 
      } catch (error) {
    ...
    <div className="w-full h-[70px] flex items-center justify-center bg-white">
        <div className="w-[90%] text-[25px] flex justify-between items-center">
                ...
                { dropdown ?
                    null
                :
                <div className=" md:hidden text-[25px] text-[#000]" onClick={showDropdown}>
                    <RiMenu4Fill />
                </div>
                }
            </div>
            ...
            <div className={` ${dropdown ? 'transform translate-y-0' : 'transform -translate-x-full'} lg:hidden w-[100%] h-[100vh] absolute bg-whit backdrop-blur-m bg-[#f9ffec] bg-opacity-6 top-0 transition-all ease-in-out z-30 duration-300`} onClick={showDropdown}>

                <div className='w-full flex items-center justify-between mt-[30px p-[30px]'>
                    <h1 className='font-bold text-[20px]'>LOGO</h1>

                    <div className="lg:hidden text-[25px] cursor-pointer  ml-[6px] shadow-md text-[#000]  z-50 p-1 rounded-md bg-white absolut right-[15px] top-[25px]" onClick={showDropdown}>
                        <MdClose/> 
                    </div>
                </div>

                {/* <div className="lg:hidden text-[25px] cursor-pointer  ml-[6px] shadow-md text-[#000]  z-50 p-1 rounded-md bg-white absolute right-[15px] top-[25px]" onClick={showDropdown}>
                    <MdClose/> 
                </div> */}

                <div className="w-full h-[320px  flex flex-col pl-[30px] sm:pl-[35px] pt-[25px] text-[13px] gap-6 text-[#1f2035 top-[70px] absolute ">
                    ...
                    <NavLink to="/dashboard/uploadscholarship">
                    <ol  
                    onClick={() => handleSetActive("upload")}
                    className={`text-[#000] flex gap-3 items-center font-bold cursor-pointer ${getActiveClass("/dashboard/uploadscholarship")}`}>
                    ...
                    className={`text-[#000] flex gap-3 items-center font-bold cursor-pointer ${getActiveClass("/dashboard/messages")}`}>
                    {/* <img src={upload} className="" alt="" /> */}
                    {icons.messages}
                        Messages
                    </ol>
